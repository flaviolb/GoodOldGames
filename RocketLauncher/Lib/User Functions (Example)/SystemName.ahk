; Code in this file will only be run for the system whose name matches the filename of this file
; Do not change the line with the class declaration! The class name must always be SystemUserFunction and extend UserFunction
