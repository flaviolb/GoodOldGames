; Code in this file will only be run for the emulator whose name matches the filename of this file
; Do not change the line with the class declaration! The class name must always be GlobalEmulatorUserFunction and extend UserFunction
