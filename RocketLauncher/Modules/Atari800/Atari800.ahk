...
;
; When emulating a lightgun with the mouse, press the right mouse button to enable the on-screen target cursor
;
;----------------------------------------------------------------------------
StartModule()
BezelGUI()
...
Sleep, 500 ;Without this sometimes the window content won't be properly resized. Increase this value if this is still happening
BezelDraw()
