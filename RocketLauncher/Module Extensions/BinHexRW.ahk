...
BinWrite(file, ByRef data, n:=0, offset:=0) {
	...
	IfNotEqual ErrorLevel,0, {
		Log("BinWrite - Ended - Couldn't create the file. Possibly this file is in use by another application.",3)
...
BinRead(file, ByRef data, n:=0, offset:=0) {
	Log("BinRead - Reading " . n . " bytes from offset " . offset . " in " . file)
	h := DllCall("CreateFile","Str",file,"Uint",0x80000000,"Uint",3,"UInt",0,"UInt",3,"Uint",0,"UInt",0)
	IfEqual h,-1, SetEnv, ErrorLevel, -1
	IfNotEqual ErrorLevel,0, {
		Log("BinRead - Ended - Couldn't create the file. Possibly this file is in use by another application.",3)
