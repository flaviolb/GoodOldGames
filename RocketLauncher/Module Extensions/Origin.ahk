...
Origin(aName, aPath, params:="") {
	...
	OriginLaunch:	; Origin is not running
		...
		oP := Decrypt(oP,"k")
		If (!oU || !oP)
			ScriptError("OriginLaunch - Origin is not running and needs to be logged in to launch this Origin game. RocketLauncher can do this, but you need to run ""EncryptPasswords"" application in your PCLauncher module folder first and set your login credentials.")
